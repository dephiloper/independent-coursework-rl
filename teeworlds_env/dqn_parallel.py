...
# exp collecting
NUM_WORKERS = 4
COLLECT_EXPERIENCE_SIZE = 5000  # init: 2000 (amount of experiences to collect after each training step)
...
REPLAY_SIZE = 100000  # init: 10000 (max capacity of replay buffer)
...
SYNC_TARGET_FRAMES = COLLECT_EXPERIENCE_SIZE * 2  # init: 1000 (how frequently we sync target net with net)

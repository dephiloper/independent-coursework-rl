...
\begin{align}
  ...
  L & = \left(Q(s, a) - (r + \gamma \max_{a'} Q(s', a'))\right)^2 \label{aln:DeepQLoss2}
\end{align}
\noindent
...
Diesen Vorgang wiederholt man, bis die vom Netz vorhergesagten Q-Values den tatsächlichen
Values der Actions entsprechen.\\
...
\begin{align}
  L & = \left(Q(s, a) - (r + \gamma \max_{a'} \textbf{Q'(s', a')})\right)^2
...
Environment implementiert und getestet.

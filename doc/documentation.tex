...
welche auch als Vanilla Deep-Q-learning bezeichnet wird. Die nachfolgenden Graphen veranschaulichen
den während des Trainingsprozesses erhaltenen durchschnittlichen Reward sowie der, für den Verlauf des
Explorationprozesses verwendeten $\epsilon$ Wert (\ref{fig:vanilla-dqn}):

\begin{figure}[htp]
\centering
\includegraphics[scale=0.28]{res/vanilla_dqn.png}
\includegraphics[scale=0.38]{res/epsilon_vanilla_dqn.png}
...
durchschnittlichen Reward von 12.9, wobei der maximal zu erhaltene Reward bei vier Karten bei 14
liegt. Aufgrund der Anordnung von Schilden in der Karte ist dieses Ergebnis jedoch als ein erfolgreiches
Lösen der gestellten Problemstellung einzuordnen.

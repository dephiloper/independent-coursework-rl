...
Algorithmen und Erweiterungen besteht der abschließende Teil dieses Independent Coursework darin,
ein eigenes Environment zu entwickeln. Anhand dieses Environments soll ein Reinforcement Learning
Verfahren implementiert werden, mit dem Ziel die Problemstellung dss Environments erfolgreich zu 
...
\subsubsection{Noisy Network} % TODO Philipp
Beschreibung, Implementierungen, Graphen
...
\subsection{Ergebnisse} % TODO Bruno
\begin{itemize}
\itemsep0pt	
...
\subsection{Ausblick} % TODO Bruno
\begin{itemize}
\itemsep0pt	

...
kann. Abschließend konnte durch die Einbindung der Noisy Layer Erweiterung, ein besseres
Trainingsergebnis erziehlt werden. In \autoref{fig:noisy-dqn} wird erneut die Entwicklung des
durchschnittlichen Rewards des Noisy Deep Q-learning Verfahrens (blau) im Vergleich zur Entwicklung
des Vanilla Verfahrens (rot) veranschaulicht:

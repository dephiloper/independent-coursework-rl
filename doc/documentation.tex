...
Q-Values mit Nullen initialisiert, um sie dann iterativ zu bestimmen.  Dazu wird eine
zufällige Action ausgewählt und in einem Environment ausprobiert.
Daraus resultieren ein State, eine Action, ein Reward und ein Folgestate, auch SARS-Tupel. Der erste State ist der Ausgangszustand, in dem
man anschließend die Action getätigt hat. Als Folge auf das Ausführen dieser Action erhält
man einen unmittelbaren Reward, sowie einen Folgestate
...
besten zu erwartenden long-term Reward des Folgezustandes. Der Wert des Folgezustandes

...
lernende Entität, auch \textit{Agent}, keine bezeichneten Beispiele für das Lösen eines Problemes % TODO bezeichneten/Problems?
...
Stattdessen gibt es ausschließlich Ab\-schätzungen bezüglich des values einer Action, die
aus den gesammelten Erfahrungen hervorgehen. Um den value einer Action besser abschätzen
zu können, muss diese Action ausprobiert werden. Umso häufiger die Action ausgeführt
wurde, umso besser ist auch die Abschätzung des values dieser Action.
...
oder auch wahrgenommen. Anschließend erfolgt die Berechnung des total Rewards für jede gespielte % TODO oder auch wahrgenommen?
...
wohingegen die restlichen schlechteren Episoden verworfen werden. Anschließend wird im letzen Schritt
...
das Bewegen in die vier Haupthimmelsrichtungen sowie das Abfeuern einer Waffe (sieben diskrete % TODO sieben diskrete Actions?
...
von DeepMind\cite{HGD2015} wird das Überbewerten von Q-values bei dem Eintreten definierter % Überwerten Überbewerten?
...
Samples für das entwickelte Environment nicht geeignet ist oder das zufällige Abweichungen
...
Um eine funktionierende Grundeinstellung der Hyperparameter und der Entwicklungsumgebung
zu erhalten wurden Experimente durchgeführt und dokumentiert. Dabei wurden Hyperparameter
und Implementierungen umgesetzt und anschließend mit einander verglichen. Informationen
zu den durchgeführten Tests sind unter
...
der Anlage unter \autoref{sec:further_train_results} zu sehen.

\subsubsection{Experiment mit 6 Leveln}
Die nachfolgende Abbildung \ref{fig:six_levels_results} veranschaulicht die Ergebnisse
eines Experiments mit 6 Leveln. Die benutzten Level sind im Anhang im
\autoref{sec:six_levels} veranschaulicht. Der Agent konnte abschließend nach 50 Stunden
und 2.8 Millionen Samples alle sechs Level erfolgreich absolvieren.

\begin{figure}[htp]
\centering
\includegraphics[scale=0.19]{res/six_levels_results.png}
...
Um zu testen in wie weit der trainierte Agent die gelernte Verhaltensweise abstrahieren
...
von neuen Hindernissen auffallen. Das Level, das für die Evaluierung verwendet wurde, wird
...
lässt sich beurteilen, dass das Verfahren overfitted und die zu spielenden Levels ''auswendig''
lernt.
...
\begin{figure}[htp]
\centering
\includegraphics[width=160pt]{res/newlevel_5_full.png}
\includegraphics[width=160pt]{res/newlevel_6_full.png}
...
\begin{figure}[htp]
\centering
\includegraphics[width=160pt]{res/hard_level.png}
...
\begin{figure}[htp]
\centering
\includegraphics[width=160pt]{res/eval_level_0.png}
